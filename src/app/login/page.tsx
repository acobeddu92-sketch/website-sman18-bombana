...
function LoginForm() {
  ...
  // Sinkronisasi jika roleParam berubah di URL
  useEffect(() => {
    if (roleParam && ROLE_NAMES[roleParam]) {
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 bg-white text-slate-800 font-medium"
            >
              <option value="">-- Deteksi Otomatis / Semua Portal --</option>
