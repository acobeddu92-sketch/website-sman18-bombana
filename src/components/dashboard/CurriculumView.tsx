...
export default function CurriculumView({ user }: Props) {
  ...
  // Selected Class Modal for Viewing Active Students (Master Data Siswa)
  ...
  // Selected Teacher Modal for Detail View
  ...
  // Modal Jadwal Kelas (Berdasarkan class_id dari Master Data TeachingSchedule)
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      if (res.ok) {
        ...
        setErrorMsg(json.error || 'Gagal memuat ringkasan dashboard.');
      }
    } catch (e) {
  ...
  // Filtered Teachers for Task Management
  ...
  }, [materialsData, materialTeacherFilter, materialClassFilter, materialSearch]);
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row font-sans">
      ...
      <aside className="hidden md:flex md:w-64 lg:w-72 bg-white border-r border-slate-200/80 flex-col shrink-0 sticky top-0 h-screen z-20 shadow-xs">
      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto w-full space-y-6">
        ...
        {errorMsg && (
          <div className="p-4 rounded-2xl bg-rose-50 border border-rose-200 text-rose-800 text-xs sm:text-sm flex items-center justify-between animate-fadeIn">
        ...
        {/* ------------------------------------------------------------- */}
        {/* TAB 1: DASHBOARD UTAMA (MONITORING PUSAT KURIKULUM) */}
        {/* ------------------------------------------------------------- */}
        {activeTab === 'dashboard' && (
          <div className="space-y-8 animate-fadeIn">
            ...
            <div className="rounded-3xl bg-gradient-to-r from-emerald-800 via-green-800 to-teal-800 text-white p-6 sm:p-8 shadow-xl shadow-emerald-950/10 relative overflow-hidden">
              <div className="relative z-10 max-w-2xl">
                ...
                <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight">
                  Pusat Kurikulum SMAN 18 Bombana
                </h1>
                <p className="text-sm sm:text-base text-emerald-100/90 mt-2 leading-relaxed">
                  Selamat datang, <strong>{user.name}</strong>. Panel ini memonitor distribusi jadwal mengajar, pembagian tugas guru, kesiapan modul pembelajaran, dan kondisi rombel sekolah secara real-time.
                </p>
                <div className="mt-6 flex flex-wrap gap-3">
                  <button
                    onClick={() => setActiveTab('jadwal')}
                    className="px-4 py-2 rounded-xl bg-white text-emerald-800 font-bold text-xs shadow-md hover:bg-emerald-50 transition-colors"
                  >
                    Lihat Seluruh Jadwal
                  </button>
                  <button
                    onClick={() => setActiveTab('monitoring')}
                    className="px-4 py-2 rounded-xl bg-emerald-700/80 text-white font-bold text-xs border border-emerald-600/60 hover:bg-emerald-700 transition-colors"
                  >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-white p-5 rounded-3xl border border-slate-200/80 shadow-xs flex flex-col justify-between">
                  ...
                  <div className="text-2xl sm:text-3xl font-extrabold text-slate-900">
                    {dashboardData ? dashboardData.stats.totalTeachers : '—'}
                  </div>
                ...
                <div className="bg-white p-5 rounded-3xl border border-slate-200/80 shadow-xs flex flex-col justify-between">
                  ...
                  <div className="text-2xl sm:text-3xl font-extrabold text-slate-900">
                    {dashboardData ? dashboardData.stats.totalClasses : '—'}
                  </div>
                ...
                <div className="bg-white p-5 rounded-3xl border border-slate-200/80 shadow-xs flex flex-col justify-between">
                  ...
                  <div className="text-2xl sm:text-3xl font-extrabold text-slate-900">
                    {dashboardData ? dashboardData.stats.totalActiveSchedules : '—'}
                  </div>
                ...
                <div className="bg-white p-5 rounded-3xl border border-slate-200/80 shadow-xs flex flex-col justify-between">
                  ...
                  <div className="text-2xl sm:text-3xl font-extrabold text-slate-900">
                    {dashboardData ? dashboardData.stats.teachersWithoutSchedule : '—'}
                  </div>
                ...
                <div className="bg-white p-5 rounded-3xl border border-slate-200/80 shadow-xs flex flex-col justify-between">
                  ...
                  <div className="text-2xl sm:text-3xl font-extrabold text-slate-900">
                    {dashboardData ? dashboardData.stats.classesWithoutSchedule : '—'}
                  </div>
                ...
                <div className="bg-white p-5 rounded-3xl border border-slate-200/80 shadow-xs flex flex-col justify-between">
                  ...
                  <div className="text-2xl sm:text-3xl font-extrabold text-slate-900">
                    {dashboardData ? `${dashboardData.stats.materialsPercentage}%` : '—'}
                  </div>
                ...
                <div className="bg-white p-5 rounded-3xl border border-slate-200/80 shadow-xs flex flex-col justify-between sm:col-span-2 lg:col-span-2">
                  ...
                  <div className="text-2xl sm:text-3xl font-extrabold text-slate-900">
                    {dashboardData ? dashboardData.stats.academicIssuesCount : '—'}
                  </div>
                  <p className="text-xs text-slate-500 mt-1">
            ...
            {/* Panel Quick Monitoring Akademik */}
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-xs">
              <div className="flex items-center justify-between pb-4 border-b border-slate-100 mb-6">
                <div>
                  <h3 className="text-base font-bold text-slate-900">Monitoring Akademik</h3>
              ...
              {dashboardData?.quickMonitoring ? (
                ...
                <div className="text-center py-6 text-slate-400 text-xs">Memuat data monitoring...</div>
              )}
            </div>
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-xs space-y-4">
              {dashboardData?.recentAnnouncements && dashboardData.recentAnnouncements.length > 0 ? (
                <div className="space-y-3">
                  {dashboardData.recentAnnouncements.map((item: any) => (
                ...
                <div className="text-center py-12 text-slate-400">
                  ...
                  <p className="text-sm font-medium">Belum ada agenda akademik yang dikonfigurasi.</p>
                  <p className="text-xs text-slate-400 mt-1">
                    Agenda akademik terintegrasi dengan data publikasi agenda resmi sekolah.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-5 rounded-3xl bg-white border border-slate-200/80 shadow-xs">
                ...
                <div className="text-2xl font-extrabold text-slate-900 mt-1">
                  {teachersData?.teachersWithTasksCount ?? '—'}
                </div>
              ...
              <div className="p-5 rounded-3xl bg-white border border-slate-200/80 shadow-xs">
                ...
                <div className="text-2xl font-extrabold text-slate-900 mt-1">
                  {teachersData?.teachersWithoutTasksCount ?? '—'}
                </div>
                <p className="text-xs text-slate-500 mt-0.5">Perlu koordinasi penugasan mata pelajaran</p>
              </div>
              <div className="p-5 rounded-3xl bg-white border border-slate-200/80 shadow-xs">
                <span className="text-xs font-bold uppercase text-slate-400">Total Slot Sesi Jadwal</span>
                <div className="text-2xl font-extrabold text-slate-900 mt-1">
                  {teachersData?.totalScheduleSlots ?? '—'}
                </div>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-slate-50 border-b border-slate-200/80 text-[11px] font-bold text-slate-400 uppercase tracking-wider">
                      ...
                      <th className="py-3.5 px-6">Mata Pelajaran &amp; Kelas</th>
                      <th className="py-3.5 px-6">Jumlah Sesi / Slot</th>
                      <th className="py-3.5 px-6">Status Beban</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-100 text-xs sm:text-sm">
                    {teachersData?.teachers
                      ?.filter((t: any) =>
                        !taskTeacherSearch ||
                        t.name.toLowerCase().includes(taskTeacherSearch.toLowerCase())
                      )
                      ?.map((teacher: any) => {
                        const hasTasks = teacher.teaching_schedules.length > 0;
                        // Ambil daftar unik mapel dan kelas
                          ...
                          <tr key={teacher.id} className="hover:bg-slate-50/70 transition-colors">
                            ...
                            <td className="py-4 px-6">
                              <span className="font-bold text-slate-900">
                                {teacher.teaching_schedules.length} Sesi
                              </span>
                            </td>
                            <td className="py-4 px-6">
                              {hasTasks ? (
                        ...
                        <tr key={teacher.id} className="hover:bg-slate-50/70 transition-colors">
                          ...
                          <td className="py-4 px-6 text-right">
                            <button
                              ...
                              className="px-3 py-1.5 rounded-xl border border-slate-200 text-xs font-semibold text-emerald-700 hover:bg-emerald-50 transition-colors inline-flex items-center gap-1"
                            >
          ...
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-5 rounded-3xl bg-white border border-slate-200/80 shadow-xs">
                ...
                <div className="text-2xl font-extrabold text-slate-900 mt-1">
                  {materialsData?.summary?.totalMaterials ?? '—'}
                </div>
              ...
              <div className="p-5 rounded-3xl bg-white border border-slate-200/80 shadow-xs">
                ...
                <div className="text-2xl font-extrabold text-slate-900 mt-1">
                  {materialsData?.summary?.teachersWithMaterialsCount ?? '—'}
                </div>
              ...
              <div className="p-5 rounded-3xl bg-white border border-slate-200/80 shadow-xs">
                ...
                <div className="text-2xl font-extrabold text-slate-900 mt-1">
                  {materialsData?.summary?.teachersWithoutMaterialsCount ?? '—'}
                </div>
          ...
          <div className="space-y-6 animate-fadeIn">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-xs sm:text-sm text-slate-500 mt-1">
                  Agregasi distribusi jadwal, beban ajar guru, dan rekap tugas dari basis data PostgreSQL.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
              <div className="p-4 rounded-2xl bg-white border border-slate-200/80 shadow-xs text-center">
                ...
                <div className="text-xl font-extrabold text-slate-900 mt-1">{statisticsData?.totals?.totalTeachers ?? '—'}</div>
              </div>
              <div className="p-4 rounded-2xl bg-white border border-slate-200/80 shadow-xs text-center">
                <span className="text-[10px] font-bold uppercase text-slate-400">Total Rombel</span>
                <div className="text-xl font-extrabold text-slate-900 mt-1">{statisticsData?.totals?.totalClasses ?? '—'}</div>
              </div>
              <div className="p-4 rounded-2xl bg-white border border-slate-200/80 shadow-xs text-center">
                <span className="text-[10px] font-bold uppercase text-slate-400">Total Siswa</span>
                <div className="text-xl font-extrabold text-slate-900 mt-1">{statisticsData?.totals?.totalStudents ?? '—'}</div>
              </div>
              <div className="p-4 rounded-2xl bg-white border border-slate-200/80 shadow-xs text-center">
                <span className="text-[10px] font-bold uppercase text-slate-400">Total Jadwal</span>
                <div className="text-xl font-extrabold text-slate-900 mt-1">{statisticsData?.totals?.totalSchedules ?? '—'}</div>
              </div>
              <div className="p-4 rounded-2xl bg-white border border-slate-200/80 shadow-xs text-center">
                <span className="text-[10px] font-bold uppercase text-slate-400">Perangkat Ajar</span>
                <div className="text-xl font-extrabold text-slate-900 mt-1">{statisticsData?.totals?.totalMaterials ?? '—'}</div>
              </div>
              <div className="p-4 rounded-2xl bg-white border border-slate-200/80 shadow-xs text-center">
                <span className="text-[10px] font-bold uppercase text-slate-400">Total Tugas</span>
                <div className="text-xl font-extrabold text-slate-900 mt-1">{statisticsData?.totals?.totalAssignments ?? '—'}</div>
              </div>
            </div>
          ...
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="bg-white rounded-3xl p-8 border border-slate-200/80 shadow-xs space-y-6 print:border-none print:shadow-none">
              <div className="text-center pb-6 border-b border-slate-200">
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  Laporan Resmi Monitoring dan Evaluasi Kurikulum Semester
                </p>
              </div>
              ...
              {/* Tabel Distribusi Guru */}
              <div className="space-y-3 pt-4">
                <h3 className="text-sm font-bold uppercase tracking-wider text-slate-700 border-b border-slate-100 pb-1">
                  II. Rekapitulasi Beban Kerja Mengajar Tenaga Pendidik
                </h3>
                <div className="overflow-x-auto">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      {statisticsData?.teacherBreakdown?.map((t: any) => (
                        <tr key={t.id}>
                          ...
                          <td className="py-2 px-4 text-center font-bold">{t.scheduleCount}</td>
                          <td className="py-2 px-4 text-center">{t.materialCount}</td>
                          <td className="py-2 px-4 text-center">{t.assignmentCount}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
